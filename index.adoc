...
include::methodology/introduction.adoc[]

include::methodology/cloud-native.adoc[]

include::methodology/continuous-delivery-integration.adoc[]

include::methodology/actors.adoc[]
